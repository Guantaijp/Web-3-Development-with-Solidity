...
// view: A function that can read state variables but cannot modify them.
// pure: A function that neither reads nor modifies state variables, only works with inputs and local variables.
